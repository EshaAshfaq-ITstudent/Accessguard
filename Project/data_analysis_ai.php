...
<header>
    ...
    <a href="TechT.WorkCour.php" class="back-link"><i class="bi bi-arrow-left"></i> Back to All Courses</a>
        ...
        <div class="course-header">
            ...
            <img src="Images/dataanalysis.jpg" alt="AI for Life Sciences">
</div>
                <div class="course-title-section">
                    <h1>Data Analytics Through AI</h1>
        ...
        <div class="info-section">
            ...
            <p>This course introduces modern data analysis techniques using AI-powered tools. Participants will learn how to collect, clean, analyze, and visualize data using Python and AI-assisted analytics tools.</p>
        </div>
    ...
    <ul>
        <li>Perform data analysis using Python</li>
        <li>Use AI tools to automate data insights</li>
        <li>Create visualizations and dashboards</li>
        <li>Apply machine learning for basic predictions</li>
    </ul>
</div>
...
<div class="info-section">
    ...
    <div class="grid-2">
        ...
        <div class="module-card">
            <h4>📘 Module 1: Introduction to Data Analytics & AI (6 Hours)</h4>
            <ul>
                <li>Data analytics lifecycle</li>
                <li>Role of AI in data analysis</li>
                <li>Tools for AI-powered analytics</li>
            </ul>
        </div>

        <!-- Module 2 -->
        <div class="module-card">
            <h4>📘 Module 2: Python for Data Analysis (8 Hours)</h4>
            <ul>
                <li>Python basics</li>
        ...
        <!-- Module 3 -->
        <div class="module-card">
            <h4>📘 Module 3: Data Cleaning and Preprocessing (8 Hours)</h4>
            <ul>
        ...
        <!-- Module 4 -->
        <div class="module-card">
            <h4>📘 Module 4: Data Visualization (8 Hours)</h4>
            <ul>
        ...
        <!-- Module 5 -->
        <div class="module-card">
            <h4>📘 Module 5: Introduction to Machine Learning (8 Hours)</h4>
            <ul>
                <li>Regression and classification</li>
                <li>Model evaluation</li>
                <li>AI-powered prediction tools</li>
            </ul>
        </div>

        <!-- Module 6 -->
        <div class="module-card">
            <h4>📘 Module 6: Real-World Data Projects (6 Hours)</h4>
            <ul>
                <li>Healthcare data analysis</li>
                <li>Business analytics case study</li>
            </ul>
        </div>
        ...
        <div class="module-card">
            ...
            <ul>
                <li>Data analysis project with visualization</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-section">
    <h2><i class="bi bi-person-check"></i> Ideal For</h2>

    <ul>
        <li>Students from Computer Science, Business Analytics, Economics, and Research fields</li>
    </ul>
</div>
        </div>
