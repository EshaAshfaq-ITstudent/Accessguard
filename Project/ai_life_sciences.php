...
<header>
    ...
    <a href="TechT.WorkCour.php" class="back-link"><i class="bi bi-arrow-left"></i> Back to All Courses</a>
        ...
        <div class="course-header">
            ...
            <img src="Images/lifescience.jpg" alt="AI for Life Sciences">
</div>
                <div class="course-title-section">
                    <h1>AI for Life Sciences</h1>
                    <div class="course-badges">
                        <span class="badge"><i class="bi bi-star-fill" style="color:#f5a623;"></i> RATING 4.5 ★</span>
        ...
        <div class="info-section">
            ...
            <p>This course introduces the application of Artificial Intelligence (AI) in Life Sciences. It focuses on how machine learning and deep learning techniques can be used to analyze biological and medical data, support disease diagnosis, accelerate drug discovery, and improve healthcare research. The course is designed for students and professionals interested in the intersection of biology, healthcare, and artificial intelligence.</p>
        </div>
        ...
        <div class="info-section">
            ...
            <ul>
                <li>Understand the fundamentals of Artificial Intelligence and Machine Learning.</li>
                <li>Explore the role of AI in healthcare and biological research.</li>
                <li>Analyze biological datasets using machine learning techniques.</li>
                <li>Apply AI models to solve problems in genomics, drug discovery, and medical imaging.</li>
                <li>•	Apply AI models to solve problems in genomics, drug discovery, and medical imaging.</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="grid-2">
                ...
                <div class="module-card">
                    <h4>📘 Module 1: Introduction to AI and Life Sciences (6 Hours)</h4>
                    <ul>
                        <li>Overview of Artificial Intelligence</li>
                        <li>Introduction to Life Sciences data</li>
                        <li>AI applications in healthcare and biotechnology</li>
                    </ul>
                </div>
                <!-- Module 2 -->
                <div class="module-card">
                    <h4>📘 Module 2: Fundamentals of Machine Learning (8 Hours)</h4>
                    <ul>
                ...
                <!-- Module 3 -->
                <div class="module-card">
                    <h4>📘 Module 3: Data Handling in Life Sciences (8 Hours)</h4>
                    <ul>
                        <li>Biological and medical datasets</li>
                ...
                <!-- Module 4 -->
                <div class="module-card">
                    <h4>📘 Module 4: AI in Genomics and Bioinformatics (8 Hours)</h4>
                    <ul>
                        <li>AI applications in genomics</li>
                ...
                <!-- Module 5 -->
                <div class="module-card">
                    <h4>📘 Module 5: AI in Medical Imaging (8 Hours)</h4>
                    <ul>
                        <li>Image processing basics</li>
                        <li>Deep learning for medical image analysis</li>
                        <li>Disease detection using AI</li>
                    </ul>
                </div>

                <div class="module-card">
                    <h4>📘 Module 6: AI in Drug Discovery and Healthcare (6 Hours)</h4>
                    <ul>
                ...
                <div class="module-card">
                    <h4>📘 Module 7: Ethics and Future of AI in Life Sciences (4 Hours)</h4>
                    <ul>
        ...
        <div class="info-section">
            ...
            <ul>
                <li><strong>Students</strong> of Computer Science, Biotechnology, Bioinformatics, Health Sciences</li>
                <li><strong>Researchers</strong> and professionals interested in AI applications in biology and healthcare</li>
                <li><strong>Beginners</strong> with basic programming knowledge wanting to enter AI field</li>
                <li><strong>Career switchers</strong> looking to upskill in data science and AI</li>
            </ul>
        </div>
