...
<header>
    ...
    <a href="TechT.WorkCour.php" class="back-link"><i class="bi bi-arrow-left"></i> Back to All Courses</a>
        ...
        <div class="course-header">
            ...
            <img src="Images/linkedin.jpg" alt="AI for Life Sciences">
</div>
                <div class="course-title-section">
                    <h1>Personal Branding through LinkedIn</h1>
                    <div class="course-badges">
                        <span class="badge"><i class="bi bi-star-fill" style="color:#f5a623;"></i> RATING 4.8 ★</span>
                        <span class="badge"><i class="bi bi-clock"></i> 24 Hours</span>
        ...
        <div class="info-section">
            ...
            <p>This course helps students and professionals build a strong digital presence using LinkedIn. Participants will learn strategies for networking, personal branding, career growth, and attracting opportunities through an optimized LinkedIn profile.</p>
        </div>
    ...
    <li>Develop a strong personal brand</li>
    <li>Build professional networks</li>
    <li>Use LinkedIn for career opportunities and business growth</li>
</ul>
        </div>
    ...
    <div class="grid-2">
        ...
        <div class="module-card">
            <h4>📘 Module 1: Introduction to Personal Branding (4 Hours)</h4>
            <ul>
                <li>Importance of personal branding</li>
                <li>Building professional identity</li>
            </ul>
        </div>

        <!-- Module 2 -->
        <div class="module-card">
            <h4>📘 Module 2: LinkedIn Profile Optimization (6 Hours)</h4>
            <ul>
                <li>Profile headline and summary</li>
                <li>Professional photo and banner</li>
        ...
        <!-- Module 3 -->
        <div class="module-card">
            <h4>📘 Module 3: Content Strategy (4 Hours)</h4>
            <ul>
                <li>Writing engaging posts</li>
                <li>Storytelling for professionals</li>
        ...
        <!-- Module 4 -->
        <div class="module-card">
            <h4>📘 Module 4: Networking Strategies (4 Hours)</h4>
            <ul>
        ...
        <!-- Module 5 -->
        <div class="module-card">
            <h4>📘 Module 5: LinkedIn for Career Growth (4 Hours)</h4>
            <ul>
        ...
        <!-- Module 6 -->
        <div class="module-card">
            <h4>📘 Module 6: Personal Branding Project (2 Hours)</h4>
            <ul>
                <li>Profile review and improvement</li>
            </ul>
        </div>
        ...
        <div class="info-section">
            ...
            <ul>
                <li>Students and professionals who want to build visibility, networking opportunities, and career growth</li>
        ...
        <div class="info-section">
            ...
            <ul>
                <li>Final Review:Profile review and improvement at end</li>
                <li>Certificate: Course completion certificate from ConnecToLead</li>
            </ul>
        </div>
